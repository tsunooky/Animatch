Shader "Destructible 2D/Diffuse"
{
	Properties
	{
		...
		[Toggle(_D2D_COMBINE_RGB)] _D2dCombineRGB("	Combine Destructible RGB", Float) = 0
		[Toggle(_D2D_KEEP_ALPHA)] _D2dKeepAlpha("	Keep Original Sprite Alpha", Float) = 0
	...
	SubShader
	{
		...
		// D2D
		#pragma shader_feature_local _ _D2D_COMBINE_RGB
		#pragma shader_feature_local _ _D2D_KEEP_ALPHA
