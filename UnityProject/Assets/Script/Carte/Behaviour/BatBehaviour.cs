...
public class BatBehaviour : CarteBehaviour
{
    ...
    {
        // Création d'un pivot pour ajuster le pivot de rotation de la batte
        ...
        // Animation de la rotation de la batte pour un tour complet de 360 degrés
        while (elapsedTime < duration)
        {
            elapsedTime += Time.deltaTime;
            float t = elapsedTime / duration;

            // Interpolation de l'angle pour faire un tour complet de 360 degrés
